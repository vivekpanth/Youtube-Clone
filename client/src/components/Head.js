...
const Head = () => {
  ...
  return (
    ...
    <img onClick={()=>toggleMenuHandler()} className='h-8 pr-2 cursor-pointer' src="https://paragondigital.com/wp-content/uploads/Menu-Icon2.jpg" alt="menu" />
    <a href="/"><img className='h-8 pl-2' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRCa4EDbkI8ATSXs7s-ovSP2cX_Qfw06aSRWA&usqp=CAU" alt="Logo" /></a>
    </div>
